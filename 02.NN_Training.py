...
parser.add_argument("--run_code",      type=str,   default="",   help="Short code prefix for this run")
...
prefix = f"{RUN_CODE}" if RUN_CODE else ""
log_path = runs_dir / f"{prefix}train_log_{run_tag}.csv"
...
test_path = runs_dir / f"{prefix}test_metrics_{run_tag}.csv"
